//
//  GameDetailCoreDataManager.swift
//  PlayerArea
//
...
final class GameDetailCoreDataManager: GameDetailCoreDataFetchable {

    private let gameDetailCoreDataManager: CoreDataProviderProtocol
    
    init(gameDetailCoreDataManager: CoreDataProviderProtocol) {
